!(function () {
  ...
  function t(e, t) {
    e = e
      ...
      .replace(/<%-sTitle%>/g, encodeURIComponent(t.sTitle))
      .replace(/<%-sDesc%>/g, encodeURIComponent(t.sDesc))
  ...
  function s(e, o) {
    "weibo" === e
      ...
      : "facebook" === e
      ? t("https://www.facebook.com/sharer/sharer.php?u=<%-sUrl%>", o)
      : "twitter" === e
      ? t("https://twitter.com/intent/tweet?text=<%-sTitle%>&url=<%-sUrl%>", o)
      : "google" === e
      ? t("https://plus.google.com/share?url=<%-sUrl%>", o)
      : "weixin" === e &&
  ...
  !(function (e) {
    ...
    e(".nav-item-search").on("click", () => {
      ...
      e(".local-search").length &&
        e.getScript("/js/search.js", function () {
          searchFunc(
            "/search.xml",
            "local-search-input",
            "local-search-result"
      ...
      e("#gallery").justifiedGallery({ rowHeight: 200, margins: 5 }),
      e(document).ready(function (e) {
        e(".anchor").on("click", function (t) {
          t.preventDefault(),
            e("main").animate({ scrollTop: e(".cover").height() }, "smooth");
        });
      }),
      (() => {
        const t = e("#totop");
        t.hide(),
          e(".content").on("scroll", () => {
            e(".content").scrollTop() > 1e3
              ? e(t).stop().fadeTo(200, 0.6)
              : e(t).stop().fadeTo(200, 0);
          }),
          e(t).on(
            "click",
    ...
    e(".navbar-toggle").on("click", () => {
      ...
      1 == sessionStorage.getItem("darkmode")
        ? (e("body").addClass("darkmode"),
          e("#todark i").removeClass("ri-moon-line").addClass("ri-sun-line"))
        : (e("body").removeClass("darkmode"),
    ...
    (e = { id: "JGjrOr2rebvP6q2a", ck: "JGjrOr2rebvP6q2a" }),
    (function (t) {
      var o = window,
        s = document,
        r = e,
      ...
      o.LA ? o.LA.ids && i() : ((o.LA = e), (o.LA.ids = []), i()),
